...
(function (Game) {
  ...
  S.tekenGebouw = function (ctx, def, x, y, w, h, opties) {
    ...
    if (img) {
      ...
      switch (def.id) {
        ...
        default: huis(ctx, vdef, x, y, w, h, id); break;
      }

      /* Chimney (with a plume hint) and half-timber struts for higher tiers. */
  ...
  /* Chimney smoke and, as evening falls, a warm glow from the windows. Both are
     purely decorative and driven by the real-time clock / night value passed in
     `opties` (see renderer.js). */
